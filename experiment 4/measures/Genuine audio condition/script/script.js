...
const study = lab.util.fromObject({
  ...
  "metadata": {
    "title": "S4_DF_Baseline_Audio",
    "description": "Study 4 examines if genuine audio recordings (basically the audio from Experiment 3) is valenced, believable, and diagnostic of the actor's true nature.",
    "repository": "",
