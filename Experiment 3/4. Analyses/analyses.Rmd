...
# full data
data_processed <-
      read_xlsx("C:/Users/Sean/Desktop/git/DF-Impression-Formation--Video-and-Audio-/Experiment 3/2. Data/processed/data_hand_scored.xlsx") %>%
...
# Firs recode the self-reported ratings in order to compare positive and negative videos along the same scale. Do this by * the self-reported rating score by -1 for those in the negative video condition. This ensures that the negative and positive videos are being compared along the same dimension (strength) rather than valence
