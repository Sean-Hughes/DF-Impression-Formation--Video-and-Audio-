...
# Genuine Videos: Connect to the SQL Database
...
#  Deepfaked Videos: Connect to the SQL Database
...
connection <- dbConnect(
  drv=RSQLite::SQLite(),
  dbname= "raw/Experiment_3_DF_data.sqlite")
