...
genuine_data <- c("raw/Experiment_6_Genuine_data.zip")

unzip(genuine_data, exdir = "raw")

deepfaked_data <- c("raw/Experiment_6_DF_data.zip")
...
connection <- dbConnect(
  drv=RSQLite::SQLite(),
  dbname= "raw/Experiment_6_Genuine_data.sqlite")
...
connection <- dbConnect(
  drv=RSQLite::SQLite(),
  dbname= "raw/Experiment_6_DF_data.sqlite")
...
## Handscoring Open Ended Questions & Saving to Disk
...
# We asked a number of open-ended questions. In order to score them we exported the data to an excel sheet, manually scored the relevant variables, and then imported that data back into R for later analysis.

write.xlsx(data_processed, "processed/data_processed.xlsx")
