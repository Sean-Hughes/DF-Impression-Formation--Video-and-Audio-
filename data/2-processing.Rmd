...
pomp <- function(raw_sum_score, n_items, min_item_score, max_item_score, digits = 3) {
  round( 
    ( raw_sum_score - (n_items * min_item_score) ) / ( (n_items * max_item_score) - (n_items * min_item_score)),
    digits
  )
}
