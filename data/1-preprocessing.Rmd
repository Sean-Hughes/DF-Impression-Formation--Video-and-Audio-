...
# write_rds(data_database_combined_full, "processed/data_database_combined_full.rds")
...
# write_rds(data_database_combined_incremental, "processed/data_database_combined_incremental.rds")
...
data_database_combined_incremental_trimmed <- data_database_combined_incremental %>%
  filter(!(subject %in% 
...
# write_rds(data_combined, "processed/data_combined.rds")
