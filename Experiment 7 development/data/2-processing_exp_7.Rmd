...
# str_detect(colnames(data_preprocessed), "experimental_condition")
...
data_trial_level <- data_preprocessed %>%
  ...
  mutate(task = tolower(task),
         task = case_when(task == "stimulus" ~ "iat",
                          ...
                          task == "video_positive_baseline" ~ "intervention",
                          task == "video_negative_baseline" ~ "intervention",
                          task == "video_positive_genuine" ~ "intervention",
                          task == "video_negative_genuine" ~ "intervention",
                          task == "video_positive_df" ~ "intervention",
                          task == "video_negative_df" ~ "intervention",
                          task == "audio_positive_baseline" ~ "intervention",
                          task == "audio_negative_baseline" ~ "intervention",
                          task == "audio_positive_deepfake" ~ "intervention",
                          task == "audio_negative_deepfake" ~ "intervention",
                          task == "audio_positive_genuine" ~ "intervention",
                          task == "audio_negative_genuine" ~ "intervention",
                          task == "audio_positive_deepfaked" ~ "intervention",
                          task == "audio_negative_deepfaked" ~ "intervention",
                          TRUE ~ task)) %>%
