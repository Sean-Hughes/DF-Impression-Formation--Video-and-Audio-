...
data_processed_after_hand_scoring <- data_processed_after_hand_scoring %>%
  mutate(thinking_style_rei_mean = (q1_rei + q2_rei + q3_rei + q4_rei + q5_rei + q6_rei + q7_rei + q8_rei + q9_rei + q10_rei + q11_rei + q12_rei + q13_rei + q14_rei + q15_rei  + q16_rei  + q17_rei  + q18_rei  + q19_rei  + q20_rei)/20) 
...
results_iat_selfreports_video_content <- data_processed_after_exclusions %>%
...
results_iat_selfreports_video_type <- data_processed_after_exclusions %>%
...
data_processed_after_exclusions %>% sample_n_by(experiment_condition, video_type, size = 1)
...
results_video_type_video_content <- data_processed_after_exclusions %>% anova_test(self_reported_rating ~ experiment_condition * video_type)
