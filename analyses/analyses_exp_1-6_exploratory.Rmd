...
# Does prior knowledge of deepfakes make people better at detecting them?
...
pp_check(fit_poisson_detection_awareness, nsamples = 100)
summary(fit_poisson_detection_awareness)
plot(fit_poisson_detection_awareness, ask = FALSE)
...
plot_model(fit_poisson_detection_awareness)
# plot(conditional_effects(fit_poisson_detection_awareness), ask = FALSE)
...
- Evidence non-zero interaction effect: incident rate ratio was > 1.  
- Results therefore suggest that aware participants were 2.6 times more likely to detect a deepfake than those who were not.
- Predicted percentage changes of detecting are below:
