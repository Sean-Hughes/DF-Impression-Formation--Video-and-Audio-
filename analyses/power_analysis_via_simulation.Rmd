...
- add other DVs
- dont forget exclusion rate when calculating necessary N
...
# summarize simulations
simulation_results_implicit <- summarize_simulation(simulation_iterations_implicit)

# print table
simulation_results_implicit$table %>%
  kable() %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "condensed"), full_width = FALSE)

# print H1 plots
simulation_results_implicit$plot1

# print H2 plot
simulation_results_implicit$plot2
...
# summarize simulations
simulation_results_intentions <- summarize_simulation(simulation_iterations_intentions)

# print table
simulation_results_intentions$table %>%
  kable() %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "condensed"), full_width = FALSE)

# print H1 plots
simulation_results_intentions$plot1

# print H2 plot
simulation_results_intentions$plot2
