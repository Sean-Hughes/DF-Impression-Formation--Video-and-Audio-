...
empirical_detection_rate <- data_processed %>%
  filter(exclude_subject == FALSE & 
           ...
           !is.na(deepfake_detected)) %>%
  summarize(percent_detected = mean(deepfake_detected)) %>%
...
fit_selfreport_detected <- read_rds("models/fit_selfreport_deepfaked_detected.rds")
fit_implicit_detected   <- read_rds("models/fit_implicit_deepfaked_detected.rds")
fit_intentions_detected <- read_rds("models/fit_intentions_deepfaked_detected.rds")
...
simulation <- function(results_file, empirical_model_fit, N_simulated_participants, iterations){
...
bind_rows(mutate(parameter_recovery_self_report$results_comparison, DV = "self report"),
          mutate(parameter_recovery_self_report$results_comparison, DV = "implicit"),
          mutate(parameter_recovery_self_report$results_comparison, DV = "intentions")) %>%
...
simulation_iterations_self_report <- 
  simulation(results_file             = "simulation_iterations_self_report",
...
simulation_iterations_implicit <- 
  simulation(results_file             = "simulation_iterations_implicit",
             empirical_model_fit      = fit_implicit, 
             N_simulated_participants = N_participants, 
             iterations               = N_simulations)

simulation_iterations_intentions <- 
  simulation(results_file             = "simulation_iterations_intentions",
             empirical_model_fit      = fit_intentions, 
             N_simulated_participants = N_participants, 
             iterations               = N_simulations)

# subsets
simulation_iterations_self_report_detected <- 
  simulation(results_file             = "simulation_iterations_self_report_detected",
             empirical_model_fit      = fit_selfreport_detected, 
             N_simulated_participants = N_participants, 
             iterations               = floor(N_simulations*empirical_detection_rate))

simulation_iterations_implicit_detected <- 
  simulation(results_file             = "simulation_iterations_implicit_detected",
             empirical_model_fit      = fit_implicit_detected, 
             N_simulated_participants = N_participants, 
             iterations               = floor(N_simulations*empirical_detection_rate))

simulation_iterations_intentions_detected <- 
  simulation(results_file             = "simulation_iterations_intentions_detected",
             empirical_model_fit      = fit_intentions_detected, 
             N_simulated_participants = N_participants, 
             iterations               = floor(N_simulations*empirical_detection_rate))
