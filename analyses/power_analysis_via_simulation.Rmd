...
if(file.exists("models/simulation_iterations_self_report.csv")){
  simulation_iterations_self_report <- read.csv("models/simulation_iterations_self_report.csv")
} else {
  # run simulations
...
if(file.exists("models/simulation_iterations_implicit.csv")){
  simulation_iterations_implicit <- read.csv("models/simulation_iterations_implicit.csv")
} else {
  # run simulations
...
if(file.exists("models/simulation_iterations_intentions.csv")){
  simulation_iterations_intentions <- read.csv("models/simulation_iterations_intentions.csv")
} else {
  # run simulations
