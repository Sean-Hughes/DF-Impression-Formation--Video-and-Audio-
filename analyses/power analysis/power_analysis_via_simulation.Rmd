---
title: "Power analyses for Confirmatory Experiment 5"
...
- Note: this power analysis was conducted on six exploratory studies that were carried out. During the review process (as noted in the analyses_confirmatory_exp_5_preregistered script), the editor requested that we drop experiments 1-2 which only focused on authentic content, and report experiments 3-6 which focused on Deepfaked content. As such, this is the reason why the power analysis was conducted on six rather than just four studies.  
